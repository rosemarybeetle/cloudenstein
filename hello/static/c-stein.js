...
function refresh_face(){
 ...
 var hh = window.innerHeight;
  ...
  lbrain=String((ww*.29)+'px')
  wbrain=String((ww*.6)+'px')
  hbrain=String((hh*.2)+'px')
  hbrain=String('3%');


   document.getElementById('brain_div').style.left=lbrain;
   document.getElementById('brain_div').style.width=wbrain;
   document.getElementById('brain_div').style.height='3%';
 lll=String((ww*.12)+'px')
  window.llll = lll;
  rrr=String((ww*.33)+'px')
  window.rrrr=rrr;
